...
def test_get_student_with_more_classes():
    ...
    grace = Student(
        "Grace Hopper",
        "senior",
        ["mathematics", "art of computing", "english"]
    )
    
    assert get_student_with_more_classes(charles, ada) == ada
    assert get_student_with_more_classes(grace, charles) == grace
